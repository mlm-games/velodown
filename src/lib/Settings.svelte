    ...
    <form onsubmit={handleSubmit}>
      ...
      <div class="form-group">
        ...
        <div class="folder-selector">
          <input
            ...
            readonly
          />
          <button type="button" onclick={chooseFolder} class="browse-btn"
            >Browse...</button
          >
        </div>
      </div>
      ...
      <div class="grid-2">
        <div class="form-group checkbox-group">
          <label
            ><input type="checkbox" bind:checked={settings.autoStart} /> Auto-start
            downloads</label
          >
        </div>
        <div class="form-group checkbox-group">
        ...
        <div class="grid-3">
          <div class="form-group">
            ...
            <input
              id="resume-attempts"
              type="number"
              bind:value={settings.maxResumeAttempts}
              min="1"
              max="20"
            />
          </div>
          <div class="form-group">
            ...
            <input
              id="resume-delay"
              type="number"
              bind:value={settings.resumeDelaySeconds}
              min="5"
              max="300"
            />
          </div>
          <div class="form-group">
            ...
            <input
              id="quick-fail"
              type="number"
              bind:value={settings.minFailDurationSeconds}
              min="5"
              max="60"
            />
